<template>
  <div>
    ...
    <p style="margin: 0px 0px 10px 0px; text-align: center; font-size: 0px">
      <a
        href="https://www.addevent.com/event/uF14363456+apple"
        title="Apple"
        target="_blank"
        ...
        ><img
          ...
          width="35"
          border="35"
          style="width: 35px; display: inline" /></a
      ><a
        href="https://www.addevent.com/event/uF14363456+google"
        title="Google"
        target="_blank"
        style="display: inline"
        ><img
          ...
          style="width: 35px; display: inline" /></a
      ><a
        href="https://www.addevent.com/event/uF14363456+outlook"
        title="Outlook"
        target="_blank"
        style="display: inline"
        ><img
          ...
          style="width: 35px; display: inline" /></a
      ><a
        href="https://www.addevent.com/event/uF14363456+yahoo"
        title="Yahoo"
        target="_blank"
        ><img
